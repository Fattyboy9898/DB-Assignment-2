...
df2tgt = df2max.union(df2min)
df2tgt = df2tgt.join(df2,["Name","City","Price Range","Rating"],'inner').sort("City","Price Range","Rating")
df2tgt = df2tgt.select("_c0","Name","City","Cuisine Style","Ranking","Rating","Price Range","Number of Reviews","Reviews","URL_TA","ID_TA")
df2tgt.show()
